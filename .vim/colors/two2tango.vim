...
execute "hi Statement    guifg=" . s:Butter[2]
...
execute "hi IncSearch    gui=none guibg=" . s:Butter[0] . " guifg=" . s:Orange[2] 
...
execute "hi Search       guibg=" . s:Butter[0] . " guifg=" . s:Orange[2]
...
highlight Visual                    guibg=#212628 ctermbg=60

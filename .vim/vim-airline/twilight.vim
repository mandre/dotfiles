...
let g:airline#themes#twilight#palette.accents = {
      \ 'red': [ '#ff7400' , '' , 196 , '' , '' ],
      \ }
...
let g:airline#themes#twilight#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)
let g:airline#themes#twilight#palette.normal_modified = {
      \ 'airline_c' : [ s:N4[0] , s:N3[1] , s:N4[1] , s:N3[3] , '' ] }


let g:airline#themes#twilight#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
...
let g:airline#themes#twilight#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
let g:airline#themes#twilight#palette.visual_modified = {
      \ 'airline_c' : [ s:N4[0] , s:V3[1] , s:N4[1] , s:V3[3] , '' ] }

let g:airline#themes#twilight#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
